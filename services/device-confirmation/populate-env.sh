...
# ============================
# CONFIRMATION SERVICE CONFIG
# ============================

SERVICE_NAME1="deviceconf"     
SERVICE_NAME="deviceconfirmation"     
DB_NAME="DeviceConfirmationDB"      
CONTAINER_NAME="StaffActions"        
...
STORAGE="${SERVICE_NAME1}${ENVIRONMENT}ab07sa"
